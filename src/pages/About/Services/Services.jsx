...
const Services = () => {
    ...
    return (
        ...
        <div className="flex flex-wrap gap-5 justify-around py-3">
            ...
            <div  className="flex-1 p-3 border-2  w-80 border-[#E3E7FA] rounded-md hover:border-none hover:shadow-xl hover:shadow-[#9eadead7] transition duration-300 ease-in-out">
            ...
            <div className="flex-1 p-3  border-2 border-[#E3E7FA] rounded-md hover:border-none hover:shadow-xl hover:shadow-[#9eadead7] transition duration-300 ease-in-out w-80">
