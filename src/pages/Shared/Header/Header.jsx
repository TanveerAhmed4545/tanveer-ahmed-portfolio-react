      ...
      <div className={"px-[2.5%]"}>
        <nav className="flex gap-3 justify-between items-center py-2 ">
            ...
            <div className="flex gap-1 items-center">
              ...
              <p>
                <span className="font-semibold uppercase text-xl">
                  <span className="text-primary"> T</span>anveer{" "}
                </span>
              </p>
            </div>
          </label>
          ...
          >
            ...
            <ActiveLink to={"/"}>
              <li className="font-semibold flex items-center gap-1 hover:text-primary border-y-2 border-transparent shrink-0">
            ...
            <ActiveLink to={"/skills"}>
              <li className="font-semibold flex items-center gap-1 hover:text-primary border-y-2 border-transparent shrink-0">
                <SiHyperskill className="text-xl" />
                SKILLS
              </li>
            </ActiveLink>
          ...
          <div className="flex gap-3 items-center">
            ...
            {!menuActive && (
              <button
                ...
                className="text-3xl mr-3 lg:hidden"
              >
                <HiMenuAlt1 />
              </button>
            )}
